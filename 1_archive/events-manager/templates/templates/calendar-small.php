<?php 
/*
 * This file contains the HTML generated for small calendars. You can copy this file to yourthemefolder/1plugins/events-manager/templates and modify it in an upgrade-safe manner.
 * 

...
class WC_Admin_Help {
	...
	public function add_tabs() {
			...
			array(
				...
				'content' =>
					...
					'<p>' . sprintf(
						...
						'https://docs.woocommerce.com/documentation/1plugins/woocommerce/?utm_source=helptab&utm_medium=product&utm_content=docs&utm_campaign=woocommerceplugin'
					) . '</p>' .
					'<p>' . sprintf(
		...
		$screen->set_help_sidebar(
			...
			'<p><a href="https://wordpress.org/1plugins/woocommerce/" target="_blank">' . __( 'WordPress.org project', 'woocommerce' ) . '</a></p>' .
